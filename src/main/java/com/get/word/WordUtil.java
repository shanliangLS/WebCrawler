...
public class WordUtil {
    ...
    public static void createWord(Object object, String templateName, String filePath, String fileName) {
        try {
            //创建配置实例
...
//        information.setAuthor("authorTest");
//        information.setTitle("titleTest");
//        informationList.add(information);
//        Map<String, Object> hashMap = new HashMap<>();
//        hashMap.put("listInfo", informationList);
