...
$.extend( AutoFill.prototype, {
	...
	_actionSelector: function ( cells )
	{
		...
		if ( available.length === 1 && this.c.alwaysAsk === false ) {
			...
			// Multiple actions available - ask the end setting what they want to do
	...
	/**
	 * Update the DataTable after the setting has selected what they want to do
	 *
 ...
 * in the table when the setting has selected a range of cells. Please see the
 ...
 */
AutoFill.defaults = {
	/** @type {Boolean} Ask setting what they want to do, even for a single option */
	alwaysAsk: false,
