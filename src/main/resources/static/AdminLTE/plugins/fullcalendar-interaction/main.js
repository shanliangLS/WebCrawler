...
(function (global, factory) {
    ...
    */
    var PointerDragging = /** @class */ (function () {
        ...
        // can be called by setting of this class, to cancel touch-based scrolling for the current drag
    ...
    var AutoScroller = /** @class */ (function () {
        ...
        AutoScroller.prototype.buildCaches = function () {
            return this.queryScrollEls().map(function (el) {
                if (el === window) {
                    return new WindowScrollGeomCache(false); // false = don't listen to setting-generated scrolls
                }
                else {
                    return new ElementScrollGeomCache(el, false); // false = don't listen to setting-generated scrolls
                }
            });
        };
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        function FeaturefulElementDragging(containerEl) {
            ...
            _this.isInteracting = false; // is the setting validly moving the pointer? lasts until pointerup
    ...
    */
    ...
    /*
    Monitors when the setting clicks on a specific date/time of a component.
    ...
    */
    ...
    /*
    Tracks when the setting selects a portion of time of a component,
    ...
    var DateSelecting = /** @class */ (function (_super) {
        ...
        function DateSelecting(settings) {
            ...
            _this.handlePointerDown = function (ev) {
                ...
                // if touch, require setting to hold down
